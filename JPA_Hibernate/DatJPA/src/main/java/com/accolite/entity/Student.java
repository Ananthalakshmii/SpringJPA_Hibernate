...
public class Student {
	...
	public Student( String firstName, String lastName, String emailId,Guardian guardian) {
		...
		/*
		 * System.out.println(this.guardian+" "+guardian);
		 * System.out.println(this.firstName+" "+this.lastName+" "+this.emailId+" ");
		 * System.out.println(this.guardian.getGuardianName()+" "+this.guardian.
		 * getGuardianEmail()+" "+this.guardian.getGuardianMobile());
		 */
	}
